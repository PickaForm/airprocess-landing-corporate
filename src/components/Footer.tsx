      ...
      <div className="container mx-auto py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold mb-4">AirProcess</h3>
            ...
            <div className="space-x-4">
              ...
              <a href="https://www.youtube.com/@airprocess" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} AirProcess. {getTranslation('footer.copyright', language)}
          </p>
